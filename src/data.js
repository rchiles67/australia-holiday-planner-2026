...
export const flightNotes = [
  ...
  { id: 'perth-hobart', route: 'Perth → Hobart', time: 'Direct or one stop', detail: 'Direct service can be limited, so compare the date against connections via Melbourne or Adelaide.', href: 'https://www.google.com/travel/flights?q=Flights%20from%20Perth%20to%20Hobart%20November%202026', label: 'Check dates' },
  ...
  { id: 'perth-adelaide', route: 'Perth → Adelaide', time: 'Domestic connection', detail: 'Use this when South Australia follows Western Australia without a Tasmania section.', href: 'https://www.google.com/travel/flights?q=Flights%20from%20Perth%20to%20Adelaide%20November%202026', label: 'Compare' },
  { id: 'hobart-adelaide', route: 'Hobart → Adelaide', time: 'Domestic connection', detail: 'Compare direct dates with one-stop options when Tasmania leads into South Australia.', href: 'https://www.google.com/travel/flights?q=Flights%20from%20Hobart%20to%20Adelaide%20November%202026', label: 'Compare' },
  { id: 'hobart-london', route: 'Hobart → London', time: 'Long-haul · live search', detail: 'Usually compare through-tickets via an Australian or Asian hub; also test Launceston and Melbourne positioning options.', href: 'https://www.google.com/travel/flights?q=Flights%20from%20Hobart%20to%20London%20November%202026', label: 'Search' },
  { id: 'adelaide-london', route: 'Adelaide → London', time: 'Long-haul · live search', detail: 'Compare through-tickets via Perth, an eastern Australian hub or Asia for the best total journey.', href: 'https://www.google.com/travel/flights?q=Flights%20from%20Adelaide%20to%20London%20November%202026', label: 'Search' },
